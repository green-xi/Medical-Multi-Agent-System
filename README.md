# **MedicalAI: AI-Powered Multi-Agent Medical Assistant**
...
**MedicalAI** is a **production-ready, multi-agent medical AI system** built with **LangGraph orchestration**, achieving **90%+ factual accuracy**, **82% medical alignment**, and **<7.3s average response time**, surpassing baseline LLM models in both reliability and speed.
...
You can interact with the live AI-powered medical assistant here: [https://medicalai.onrender.com/](https://medicalai.onrender.com/)

---

## **Performance Evaluation & Benchmarking**

| **Metrics**               | **MedicalAI (Your Model)** | **LLaMA 3.1 70B**                                                                                                                                |
| ------------------------- | --------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------ |
...
* **LLM-powered primary response** engine using ChatDashScope
...
- **API Keys**: 
  - `DASHSCOPE_API_KEY` (Get from [DashScope](https://dashscope.aliyun.com/))
...
EMBEDDING_MODEL=./backend/storage/models/bge-small-zh-v1.5/BAAI/bge-small-zh-v1.5
RERANKER_MODEL=./backend/storage/models/bge-reranker-base/BAAI/bge-reranker-base
```
